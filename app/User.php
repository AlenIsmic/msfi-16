 ...
 * @property bool $paperless
 * @property string|null $phone
 * @property string|null $supply_address
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereAccNum($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User wherePaperless($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User wherePhone($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User wherePostcode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\User whereSupplyAddress($value)
 */
